...
function handleOptionClick(event) {
    ...
    // Store choice
    const dataAttribute = Object.keys(button.dataset).find(key => key !== 'feedback');
...
function incrementRedFlag() {
    ...
    // Shake animation
    redFlagCounter.parentElement.style.animation = 'none';
    setTimeout(() => {
        redFlagCounter.parentElement.style.animation = 'pulse 0.6s ease-out';
    }, 10);
}
...
function showError(feedback) {
    ...
    // Add slight shake to modal
    errorModal.style.animation = 'none';
    setTimeout(() => {
        errorModal.style.animation = 'shake 0.5s ease-out';
    }, 10);
}
...
function showCongrats() {
    ...
    congratsModal.style.animation = 'none';
    setTimeout(() => {
        congratsModal.style.animation = 'celebrate 0.6s ease-out';
    }, 10);
}
...
console.log('%cWelcome to Cupid\'s Chaos! 💕', 'color: #ff4458; font-size: 20px; font-weight: bold;');
console.log('%cEvery choice leads to the same place: It\'s Complicated 😅', 'color: #ffa3ab; font-size: 14px;');
console.log('%cWill you collect all the red flags?', 'color: #ff6b7a; font-size: 14px;');
...
console.log('%cTip: Type getGameStats() in the console to see your current game state!', 'color: #6c6c7c; font-size: 12px;');
